...
We leverage [lastlogin.io](https://lastlogin.io) to provide a simple and secure authentication mechanism. I might host my own instance of lastlogin in the future, but for now, I'm choosed to rely on the public instance.
